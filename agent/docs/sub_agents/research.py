...
# REMOVED: from langchain_core.pydantic_v1 import BaseModel as V1BaseModel
...
class MarketResearcher:
    ...
    def research(self) -> MarketResearchReport:
        ...
        try:
            ...
            keyword_report = self._identify_keywords()
            ...
            competitors = self._analyze_competitors(keyword_report.primary_keyword)
            ...
            content_gap_report = self._find_content_gaps(competitor_snippets)
    ...
    def _analyze_competitors(self, primary_keyword: str) -> List[dict]:
        """Uses Tavily Search to find top competing pages."""
        return self.search_tool.invoke(f"top articles about {primary_keyword}")
